      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <h3 className="text-lg font-semibold mb-2">Code Privacy</h3>
            <p className="text-gray-600 text-sm">
        ...
        <div className="space-y-12">
          <section>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="font-semibold mb-4">What We Protect</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Account credentials and personal information</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Payment information (tokenized via Stripe)</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Git metadata and commit history</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Team collaboration data</span>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">TLS 1.3 encryption in transit</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Regular security patches and updates</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-600">Strict access logging and monitoring</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="bg-blue-100 rounded-lg p-4 mb-4">
                    <FileKey className="h-8 w-8 text-blue-600 mx-auto" />
                  </div>
          ...
          <section>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              <h3 className="font-semibold mb-4">Recommendations for Users:</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <span className="text-blue-600 font-bold mr-3">1.</span>
                  <span className="text-gray-600">Enable two-factor authentication on your account</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 font-bold mr-3">2.</span>
                  <span className="text-gray-600">Use strong, unique passwords for your Git Commit AI account</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 font-bold mr-3">3.</span>
                  <span className="text-gray-600">Regularly rotate API keys and access tokens</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 font-bold mr-3">4.</span>
                  <span className="text-gray-600">Review team member access permissions periodically</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 font-bold mr-3">5.</span>
                  <span className="text-gray-600">Keep your CLI tools and integrations updated</span>
                </li>
              </ul>
            </div>
          </section>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Isolate affected systems within minutes</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-orange-100 rounded-full p-2 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Thorough analysis by our security team</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-orange-100 rounded-full p-2 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Transparent communication within 72 hours</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-orange-100 rounded-full p-2 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Swift action to prevent future incidents</p>
                  </div>
                </div>
              </div>
            </div>
