      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">support@aicommit.dev</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">Monday through Friday</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Check our comprehensive docs</p>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-semibold mb-2">Can I use Git Commit AI offline?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-semibold mb-2">Do you support private repositories?</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-semibold mb-2">What programming languages are supported?</h3>
              <p className="text-gray-600 text-sm">
